  ...
  return (
    <div className="max-w-[1600px] mx-auto mb-12 px-6 lg:px-12">
      <div
        ...
        className="PageHeader py-8 lg:py-24">
      ...
      <div className="gap-8 flex lg:flex-row flex-col-reverse">
        <div
          data-aos="fade-up"
          data-aos-duration="1000"
          dangerouslySetInnerHTML={{ __html: data.content_p1 }}
          className="lg:w-4/12 lg:pr-16 mt-[-1rem] sm:w-full lg:text-xl lg:leading-9"></div>
        <div
          data-aos="fade-up"
          data-aos-duration="1000"
